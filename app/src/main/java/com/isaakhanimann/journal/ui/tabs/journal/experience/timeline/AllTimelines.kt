...
fun AllTimelines(
    ...
    // Fork-compat parameter (fork's AllTimelines had per-substance independent
    // heights); defaulted so both 4-arg and 5-arg callers compile. The upstream
    // rendering logic does not use it yet.
